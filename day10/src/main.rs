fn main() {
    //part 1
    let res = signal_strength_simple(include_str!("../input.txt"));
    println!("Signal strength: {}", res);
    //part 2
    let res = crt_simple(include_str!("../input.txt"));
    println!("CRT:\n{}", res);
}
...
fn test() {
    //part 1 simple
    let res = signal_strength_simple(include_str!("../sample.txt"));
    assert_eq!(res, 13140, "simple version");
    //part 2
    let res = crt_simple(include_str!("../sample.txt"));
    assert_eq!(
        res,
        "##..##..##..##..##..##..##..##..##..##..
###...###...###...###...###...###...###.
